...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
							...
							<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<li class="nav-item dropdown">
											...
											<div class="dropdown-menu dropdown-menu-end p-0" style="min-width: 360px;">
												...
												{{-- هذا العنصر سنستبدل محتواه عبر الـ Polling --}}
												<div id="notif-list">
													@include('admin.notifications._list', ['notifications' => ($adminLatestNotifications ?? collect())])
												</div>
											</div>
										</li>
								...
								<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										@if($avatarUrl)
										<img id="navbarAvatar" src="{{ $avatarUrl }}" alt="user"
											class="rounded-circle" style="width:40px;height:40px;object-fit:cover;">
										@else
										<div class="symbol-label rounded-circle bg-light text-muted fw-bold d-flex align-items-center justify-content-center"
											style="width:40px;height:40px;">{{ $initial }}</div>
										@endif
									</div>
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													...
													@else
													<div class="symbol-label rounded-circle bg-light text-muted fw-bold d-flex align-items-center justify-content-center"
														style="width:50px;height:50px;">{{ $initial }}</div>
													@endif
										...
										<div class="menu-item px-5 my-1">
											<a href="{{ route('admin.profile_password.edit') }}" class="menu-link px-5">Password Settings</a>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
				...
				<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">EduCloudLab</a>
						</div>
						<!--end::Copyright-->
						<!--begin::Menu-->
						...
						<div class="mb-0">
							...
							<div class="row g-5">
								...
								<div class="col-6">
									...
									<div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
										<div class="overlay-wrapper">
											<img src="{{asset('assets/media/demos/demo21.png')}}" alt="demo" class="w-100 opacity-25" />
										</div>
										<div class="overlay-layer bg-dark bg-opacity-10">
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			...
			const urlBadge = "{{ route('admin.notifications.badge') }}";
			const urlDropdown = "{{ route('admin.notifications.dropdown') }}";

			async function refreshNotifications() {
				try {
					const res = await fetch(urlDropdown, {
						headers: {
